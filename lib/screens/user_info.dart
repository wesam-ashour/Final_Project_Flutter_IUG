              ...
              SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    ...
                    userListTile('Email', '${user.email}', 0, context),
                    // userListTile('Name', '${user.displayName ?? 'Anonymous'}', 0, context),
                    // userListTile('Phone number', '${user.phoneNumber}', 1, context),
                    userListTile('Shipping address', '', 2, context),
                    userListTile('joined date', '${user.metadata.creationTime}', 3, context),
                    Padding(
                      padding: const EdgeInsets.only(left: 8.0),
